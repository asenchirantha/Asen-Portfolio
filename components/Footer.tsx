  ...
  return (
    <footer className="border-t border-gray-200 dark:border-white/10 mt-12 py-8 bg-white dark:bg-[#0a0f1e] transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <p className="text-sm text-gray-600 dark:text-gray-400 transition-colors">© {new Date().getFullYear()} Asen Chirantha. Built with Next.js and Framer Motion. Powered by Acphix</p>
        <div className="mt-3">
